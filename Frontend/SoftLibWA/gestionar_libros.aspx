                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="lblFormato" runat="server" Text="Formato:" CssClass="col-form-label" />
                                    <asp:DropDownList ID="DropDownListFormato" CssClass="form-select" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
